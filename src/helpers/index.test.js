...
describe("get remaining grade for approval", () => {
  ...
  it("should return '100 - average', rounded up, if approval equals 'Exame Final'", () => {
    ...
    averageGrade = 55;
    expect(helpers.remainingGradeForApproval(approvalStatus, averageGrade)).toEqual(45);
  });
  it("should return '0', if approval != 'Exame Final'", () => {
    approvalStatus = "Aprovado";
    expect(helpers.remainingGradeForApproval(approvalStatus, averageGrade)).toEqual(0);
